...
export function signPayload(keyPath: string, payload: string, namespace = SSH_SIGNING_NAMESPACE) {
...
function validateSshDestination(sshHost: string) {
...
function validateTcpPort(port: number, label: string) {
