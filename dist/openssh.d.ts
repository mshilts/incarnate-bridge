...
export declare function defaultKeyPath(fileName?: string): string;
...
export declare function signPayload(keyPath: string, payload: string, namespace?: string): string;
